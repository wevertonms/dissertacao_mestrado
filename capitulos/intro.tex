...
Por outro lado, no cenário mundial existe a tendência mundial da indústria de óleo e gas de abraçar a transformação digital em todas as áreas da cadeia, com desenvolvimento de práticas e ferramentas para análise, visualização, predição e resultados \cite{Mittal2017}.
...
\begin{itemize}
    \item \autoref{chap:viv}: apresenta os conceitos e as formulação por trás da Vibração Induzida por Vórtice (VIV), e as recomendações dados pela referência técnica \dnvf105;
