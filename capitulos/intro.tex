...
% TODO A meu ver, por se tratar de um texto científico, uma introdução adequada deve seguir a seguinte organização (não precisa ser organizado em itens. Estou enumerando para facilitar o entendimento):

% 1. Contextualização do problema;
% 2. Levantamento dos principais trabalhos disponíveis na literatura que tratam do contexto do trabalho, destacando as vantagens e desvantagens de cada um, caso seja possível;
% 3. Uma ou mais desvantagens apresentadas podem direcionar a motivação do trabalho. É um gancho para apresentação dos objetivos;
% 4. Objetivos;
% 5. Metodologia adotada (isto pode ser escrito em um capítulo a parte, como parece que você fez);
% 6. Principais contribuições do trabalho, destacando ganhos com o uso da proposta apresentada;
% 7. delimitação do trabalho.

% Na minha forma de ver, o item 2 não está apresentado de forma clara. Acho que seria interessante encaixar no texto uma revisão bibliográfica de trabalhos relacionados mais detalhada.

% Além disso, também senti falta do item 6.
...
% Isso não é o objetivo, mas sim resultado esperado. Deveria estar escrito em outra parte do documento, ou pelo menos no final dessa seção, mas não aqui.
...
\input{capitulos/organizacao}  % TODO: Nos últimos trabalhos que tem visto essa seção não está sendo incorporada ao texto.
