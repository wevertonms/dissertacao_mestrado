...
\begin{itemize}
    ...
    A instanciação dessa classe deve ocorrer mediante o processamento de um arquivo principal de entrada com esses dados, possivelmente em formado JSON 
    % (\autoref{fig:json_sample}).
