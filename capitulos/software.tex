...
\begin{itemize}
    ...
    A classe armazena todas as informações para construção dos arquivos \texttt{.inp}.
    
    \item \texttt{Inp}: lida com a escrita do arquivo de entrada (\texttt{.inp}) para o Abaqus.
...
A \autoref{fig:UML} exibe um diagrama UML com esses módulos e classes, suas relações e os principais métodos e atributos das classes.
