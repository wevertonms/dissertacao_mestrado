...
% TODO: Ficou confuso esse capítulo no sentido de não distinguir o que é estudo bibliográfico e o que de fato foi implementado no projeto.
...
\begin{enumerate}
    ...
    \item Onda dinâmica e/ou de corrente.  % TODO: esse sequência de análise estrutural não foi implementada no estudo.
\end{enumerate}
...
14 & Aplicação de carga de onda e corrente & Dinâmica \\ % TODO: Não existe essa etapa no projeto. Como essa etapa é feita por Bai e Bai?
