...
\begin{enumerate}[label=(\arabic*)]
    ...
    \item Para iniciar a análise de fadiga, é necessário escolher dentre os modos de vibração obtidos na simulação numérica aqueles que mais contribuem para fadiga. Para esta tarefa, existe a metodologia presente na \dnvf105, que será abordada adiante no \autoref{sec:multimode}
\end{enumerate}