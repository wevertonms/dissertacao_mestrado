...
\begin{figure}[!hbt]
    ...
    \caption[]{Esteira de Von Kármán.}
    Fonte:~\cite{VandenAbeele2013}
...
\begin{figure}[!h]
	...
	\caption[]{Duto em Vão livre e direções das oscilações.\\Fonte:~\cite{DNV2017}.}\label{fig:freespan}
\end{figure}
...
\begin{figure}[!h]
	...
	\caption[]{Configurações típicas para vãos.\\Fonte:~\cite{Bai2014}.}\label{fig:vaos_tipicos}
\end{figure}
...
\begin{figure}[th!]
    ...
    \caption[]{Curva de modelo de resposta \textit{in-line}.\\Fonte:~\citeonline{DNV2017}}
...
\begin{figure}[th!]
    ...
    \caption[]{Curva de modelo de resposta \textit{cross-flow}.\\Fonte:~\citeonline{DNV2017}}
