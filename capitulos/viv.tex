...
Estes modelos são relações empíricas entre a velocidade reduzida e a amplitude de resposta adimensional, utilizadas para prever as amplitudes de vibração nas direções \textit{in-line} e \textit{cross-flow}~\cite{Mork2003}. %,DNV2017}.
...
De forma análoga, a \dnvf105 mostra um típico cenário de vãos múltiplos interativos (Figura~\ref{fig:jdsn-vaomult}).
