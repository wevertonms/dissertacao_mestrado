...
% fileext=lox,
% listname={Lista de códigos-fonte},
% name=Código-fonte,
% placement=htp,
...
% \renewcommand\listingscaption{Código-fonte} % custom labels, according to the docs
...
\def\frame{\textit{framework}} % FIXME: Mudar o termo "framework" para "ferramenta integrada"
% ----------------------------------------------------------
...
\include{capitulos/software}
\include{capitulos/aplicacoes}
